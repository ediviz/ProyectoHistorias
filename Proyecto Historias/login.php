            ...
            <nav class="navbar menu__navbar">
                ...
                <div class="menu-links menu__navbar">
                    <ul class="menu-lista-link">
                        <li><a class="link-active-red" href="inicio.html">Inicio</a></li>
                    </ul>
                    <a class="registro__btn" href="login.html">Acceder</a>
                </div>
            </nav>
        </header>
        ...
        <div class="formulario">
            ...
            <form action="#">
                <div class="contenedor-inputs">
                    ...
                    <span><a class="o-pass" href="olvidapass.html">Olvidastes tu contraseña?</a></span>
                    <input type="password" id="pass" placeholder="Contraseña">
                    <input type="submit" value="Acceder a mi cuenta">
            ...
            <div class="login-preg contenedor-inputs">
                <p class="desc-login">
                    ...
                    <a class="login" href="registro.php">Registrate</a>
                </p>
            </div>
